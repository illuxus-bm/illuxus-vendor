...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Cap the dialog to the visible viewport (dvh accounts for mobile
        // browser chrome hiding/showing) and let the interior scroll when
        // the form is taller than the screen. Fixes tall forms like the
        // service editor being cut off on shorter laptops.
